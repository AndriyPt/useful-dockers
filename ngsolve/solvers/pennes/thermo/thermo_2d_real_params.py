...
a = BilinearForm(thermal_conductivity * grad(u) * grad(v) * dx + u_coeficient * u * v * dx + ROBIN_BC_APLHA * u * v * ds(BORDER_GAMMA2))

f = LinearForm (heat_source * v * dx + ROBIN_BC_APLHA * (ROBIN_BC_ROOM_TEMP - BODY_TEMP) * v * ds(BORDER_GAMMA2))
