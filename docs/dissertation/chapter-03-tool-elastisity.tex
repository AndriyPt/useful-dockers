...
\textbf{Система рівнянь.} На границі $\Gamma$ побудуємо систему апроксимаційних функцій. Також на основі трикутних 
елементів і дотичних до них граничних елементів області $\Omega_3$ побудуємо такі функції. Рівняння 
\ref{eqn:elasticity_2d_bem_direct_elasticity_simplified} і \ref{eqn:elasticity_2d_bem_direct_gauchy_tensor} представимо 
у дискретному вигляді наступним чином:
