...
характеристики руками і оцінити властивості м'яких тканин. Тільки остання версія робота хірурга від Intuitive Machines
да Вінчі отримав таку функціональність (???джерело???). Першим роботом був Senhance із такою функціональністю
(джерело??? Стаття на NHI). Тим не менше, наразі обмежене коло роботів хірургів надає таку функціональність.
...
Стаття із модулем Юнга для злоякісних утворень Mechanical properties of human tumour tissues and their
implications for cancer development . E = Normal tissue 1060 Pa, Cancer - 5460 +- 3180

Стаття із коефіцієнтом Пуассона Non-invasive imaging of Young’s modulus and Poisson’s ratio in cancers in vivo
дає значення 0.31 для здорової тканини і 0.26 для ураженої.  
...
ДОДАТИ ПОСИЛАННЯ НА СВОЮ СТАТТЮ !!!
