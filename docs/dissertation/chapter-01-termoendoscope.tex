...
\noindent На частині границі $\Gamma_2$ задані умови Робіна, а на $\Gamma_1$ - Діріхле.
...
0.19 Вт/м/К. Злоякісна пухлини представлена областю $\Omega_3$. Відповідно коефіцієнт теплопровідності k буде залежати
від координат і його можна представити у вигляді наступної функції:
...
\textbf{Метаболічне тепло} У цій статті \cite{metabolic-heat-exchange-value-tumor} робиться висновок, що метаболічне 
тепло на порядок вище у злоякісному включенні. Це пояснює вищу температуру при більшому коефіцієнті теплопровідності і
перфузії крові. Тому візьмемо метаболічне тепло у неоднорідності рівним ... , а у м'якій тканині ... .

\textbf{Heat transfer coefficient}. \cite[Pennes used a heat transfer
...
is probably more reasonable;]{thermal-process-tissue-pennes-explained} 
...
м'язів людської руки у стані спокою]{kutz-zhu-heat-transfer-biological-systems}. Усереднимо це значення і візьмемо 
