...
Для різних діаметрів злоякісних включень маємо настпні результати
...
Резьтати узгоджуються із практичними висновками зроблени під час експериментів із вимірювань температури злоякісних 
